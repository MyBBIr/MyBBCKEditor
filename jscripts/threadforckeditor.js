var Thread = {
	...
	multiQuotedLoaded: function(request)
	{
		...
		else if(request.responseText)
		{
			...
			if ( CKEDITOR.instances.message.mode == 'wysiwyg' )
			{
				...
				CKEDITOR.instances.message.insertText( request.responseText );
			}
		}
	...
	quickReply: function(e)
	{
		...
		if ( CKEDITOR.instances.message.mode == 'wysiwyg' || CKEDITOR.instances.message.mode == 'source' )
		{
			editor = CKEDITOR.instances.message;
			Form.Element.setValue('message', editor.getData());
		}
